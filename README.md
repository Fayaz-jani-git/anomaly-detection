...
with open("regressor_model.pkl", 'wb') as file:
  ...
  <p>
    This project is actively maintained by Fayaz Jani Sheik, a Software Developer with 4+ years of professional experience.
    Fayaz is a Cybersecurity Graduate with hands-on experience in incident response, network defense, and secure coding practices.
    He has a proven track record in guiding labs on Python scripting and Linux security, and has supported incident investigations.
  </p>
  <p>
    Connect with Fayaz:
    <ul>
      <li>Email: <a href="mailto:fayazjani.sheik@gmail.com">fayazjani.sheik@gmail.com</a></li>
      <li>LinkedIn: <a href="https://www.linkedin.com/in/fayazjanisheik">Fayaz Jani Sheik</a></li>
    </ul>
  </p>
</body>
</html>